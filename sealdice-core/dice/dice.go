...
// GroupUploadFile describes a OneBot 11 group_upload notice file.
type GroupUploadFile struct {
	Id    string `json:"id" jsbind:"id"`
	Name  string `json:"name" jsbind:"name"`
	Size  int64  `json:"size" jsbind:"size"`
	Busid int64  `json:"busid" jsbind:"busid"`
}
...
type ExtInfo struct {
	...
	OnGroupUpload       func(ctx *MsgContext, msg *Message, file *GroupUploadFile) `jsbind:"onGroupUpload"       json:"-" yaml:"-"`
